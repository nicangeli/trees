...
@section('content')
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            <h1>Fine Nordic Christmas Trees</h1>
            <h3>Delivered to you, FREE within the M25.</h3>
            <br>
            <a href="#about" class="btn btn-dark btn-lg">Start Picking</a>
        </div>
    </header>
